...
Każda konfiguracja testowa wykonana została co najmniej 1000-krotnie. Z otrzymanych wyników obliczona została średnia arytmetyczna oraz odchylenie standardowe, ponieważ ich wykresy zbliżone są do rozkładu normalnego. Poniżej znajdują się diagramy, które to ukazują (dla wybranych metod).
...
\end{axis}
\end{tikzpicture}
\caption{Diagram przedstawiający przykładowy rozkład czasów przesyłania danych dla TCP. Krzywa prezentuje rozkład normalny ($\mu=352, \sigma=46$).}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{Diagram przedstawiający przykładowy rozkład czasów przesyłania danych dla plików. Krzywa prezentuje rozkład normalny ($\mu=2653, \sigma=111$).}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{Diagram przedstawiający przykładowy rozkład czasów przesyłania danych dla REST. Krzywa prezentuje rozkład normalny ($\mu=1928, \sigma=133$).}
\end{figure}
