...
Procesy mogą być niezależne - jeśli nie oddziaływują na inne (nie dzielą żadnych danych) lub współpracujące (ang. \textit{cooperating}) - jeśli mogą wpływać na pozostałe procesy lub inne procesy mogą oddziaływać na nie \cite{Silber06}.
